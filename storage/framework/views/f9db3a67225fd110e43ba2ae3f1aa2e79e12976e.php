    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid ms-5">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link <?php echo e(($title === 'Homepage')? 'active' : ''); ?>" aria-current="page" href="/">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link <?php echo e(($title === 'Library')? 'active' : ''); ?>" href="<?php echo e(route('library')); ?>">Library</a>
              </li>
              <li class="nav-item">
                <a class="nav-link <?php echo e(($title === 'About Page')? 'active' : ''); ?>" href="/about">About</a>
              </li>
...
</html><?php /**PATH C:\Users\Asus ROG G14\coding\Praetorian\Laravel\lntclass_a\resources\views/layouts/main.blade.php ENDPATH**/ ?>